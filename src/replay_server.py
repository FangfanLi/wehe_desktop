...
import pickle, atexit, re, urllib2, base64, reverse_geocode, hashlib
        ...
        for response_set in self.Qs[replayName][csp]:
            ...
            for response in response_set.response_list:
                ...
                try:
                    ...
                    # response.payload.replace('325240', '000000')
...
class SideChannel(object):
    ...
    def handle(self, connection, address):
        ...
        if good2go:
            ...
            LOG_ACTION(logger,
                       'Done notifying user know about granted permission: {} - {} - {}'.format(clientIP, realID,
                                                                                                testID), indent=2,
                       action=False)
        else:
            try:
                ...
                LOG_ACTION(logger,
                           '*** NoPermission. You: {} - {} - {}, OnFile: None ***'.format(clientIP, realID, testID))
    ...
    def side_channel_callback(self, *args):
        ...
        if dClient.secondarySuccess:
            ...
            if dClient.exceptions != 'ContentModification':
                command = clean_pcap(dClient.dump.dump_name, dClient.ports)
